...
Once you're in the `bash` shell, you can follow the [Linux](/#/page/install/linux) guide, which has more details. If you're just getting started, you may also need to run the following commands:
